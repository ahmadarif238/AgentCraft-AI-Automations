      ...
      <section className="py-24 bg-secondary relative">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="hidden md:block absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-px bg-white/15" />
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <div className={`w-full md:w-1/2 flex ${index % 2 === 0 ? "md:justify-end md:pr-12" : "md:justify-start md:pl-12 md:order-2"}`}>
                    <div className="bg-white/[0.06] border border-white/10 p-8 rounded-2xl shadow-lg w-full md:max-w-md relative hover:bg-white/[0.10] hover:border-primary/50 transition-colors">
                      <div className="text-6xl font-heading font-bold text-primary/20 absolute top-4 right-6 pointer-events-none">
                        {step.num}
                      </div>
                      <h3 className="text-2xl font-heading font-bold mb-4 relative z-10 text-secondary-foreground">{step.title}</h3>
                      <p className="text-secondary-foreground/80 relative z-10 leading-relaxed">
                        {step.description}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Center Node */}
                  <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-secondary border-4 border-white/15 items-center justify-center z-10">

          ...
          {caseStudies.map((system, i) => (
            ...
            >
              ...
              <div className="lg:col-span-7 flex flex-col">
                ...
                <div className="mb-6">
                  <h3 className="label-mono font-semibold text-primary mb-3 uppercase">Business Value</h3>
                ...
                <div className="mb-8">
                  <h3 className="label-mono font-semibold text-primary mb-3 uppercase">Technologies Used</h3>

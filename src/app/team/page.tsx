...
export default function TeamPage() {
  return (
    <>
      <PageHero kicker="Our Team" title="Five engineers," muted="no subcontractors.">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6">
            {team.map((member, index) => (
              <article
                key={member.id}
                className="group flex flex-col bg-card border border-border rounded-2xl p-7 transition-all duration-300 hover:border-primary/70 hover:shadow-[0_0_25px_rgba(43,107,255,0.12)] animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-both"
